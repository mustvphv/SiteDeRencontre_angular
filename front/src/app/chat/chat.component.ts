  ...
  ngOnInit() {
    ...
    if (this.chargementHistoriqueMessages === 0) {
        ...
        .subscribe((data: any) => {
          ...
          for(let i = 0; i < data[0].length; i++) {
                let tempTexte = [data[0].messageTexte, data[0].message2Texte, data[0].message3Texte, data[0].message4Texte,
                data[0].message5Texte, data[0].message6Texte, data[0].message7Texte,
                data[0].message8Texte, data[0].message9Texte, data[0].message10Texte];
